...
import LiveDataWrapper from '@/components/ui/LiveDataWrapper';
import Converter from '@/components/ui/Converter';
import TopMoversWrapper from '@/components/ui/TopMoversWrapper';
...
const Page = async ({ params }: NextPageProps) => {
  ...
  const coinDetails = [
    ...
    { label: 'Website', link: coinData.links.homepage[0], linkText: 'Homepage' },
    { label: 'Explorer', link: coinData.links.blockchain_site[0], linkText: 'Explorer' },
    { label: 'Community', link: coinData.links.subreddit_url, linkText: 'Community' },
  ];
  ...
  return (
    <main id="coin-details-page">
      ...
      <section className="secondary">
        ...
        <PriceStats coin={coinData} />

        <Suspense fallback={<div className="skeleton h-48 rounded-xl mt-8" />}>
          <TopMoversWrapper />
        </Suspense>
      </section>
    </main>
